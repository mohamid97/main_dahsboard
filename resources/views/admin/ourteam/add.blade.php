            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Add Memeber </li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="card card-info">
                ...
                <form role="form" method="post" action="{{route('admin.ourteam.store') }}"  enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="border  p-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="facebook" class="form-control" id="facebook" placeholder="Enter Facebook Link" value="{{ old('facebook') }}">
                                    @error('facebook')
                        ...
                        <div class="border  p-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="twitter" class="form-control" id="twitter" placeholder="Enter Twitter Link" value="{{ old('twitter') }}">
                                @error('twitter')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="instagram" class="form-control" id="instagram" placeholder="Enter Instagram Link" value="{{ old('instagram') }}">
                        @error('instagram')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="youtube" class="form-control" id="youtube" placeholder="Enter YouTube Link" value="{{ old('youtube') }}">
                        @error('youtube')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tiktok" class="form-control" id="tiktok" placeholder="Enter TikTok Link" value="{{ old('tiktok') }}">
                        @error('tiktok')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="linkedin" class="form-control" id="linkedin" placeholder="Enter LinkedIn Link" value="{{ old('linkedin') }}">
                        @error('linkedin')
