            ...
            <div>
                    ...
                    <a href="{{route('admin.events.add')}}" style="color: #FFF">
                        <button class="btn btn-info" >
                            <i class="nav-icon fas fa-plus"></i> Add New Event
                        </button>
                    </a>
                ...
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        @forelse($events as $index => $event)
                            <tr>
                                <td>{{ $index +1  }} </td>
                                <td>{{ $event->translate(app()->getLocale())->title }}</td>
                                <td>{{ $event->media->name }}</td>
                                <td>
